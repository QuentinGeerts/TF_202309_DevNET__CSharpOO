...
// Test du passage en négatif

Courant testNegatif = new Courant("BE123", p1, 100);
TfPognon.Ajouter(testNegatif);

Console.WriteLine(testNegatif.Solde);
try
{
    testNegatif.Retrait(10);
    Console.WriteLine(testNegatif.Solde);
    testNegatif.Retrait(1);
    Console.WriteLine(testNegatif.Solde);
}
catch (SoldeInsuffisantException e)
{
